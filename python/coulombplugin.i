...
*/
%pythonappend CoulombPlugin::CoulombForce::getBondParameters(int index, int& particle1, int& particle2,
...
class CoulombForce : public OpenMM::Force {
public:
    CoulombForce();
    ...
    */
    ...
    /*
     * Add methods for casting a Force to an CoulombForce.
    */
    %extend {
        static CoulombPlugin::CoulombForce& cast(OpenMM::Force& force) {
            return dynamic_cast<CoulombPlugin::CoulombForce&>(force);
        }

        static bool isinstance(OpenMM::Force& force) {
            return (dynamic_cast<CoulombPlugin::CoulombForce*>(&force) != NULL);
        }
    }
};
